...
exports.deleteMembersByLastPostDateTime = functions.pubsub.schedule('0 0-23 * * *').onRun(async () => {
          ...
          if (differenceInDays > group.data().autoExitDays) {
            ...
            if (member.data().isAlerted === true || members.docs.length === 5) {
              ...
              await _db.collection("notifications").doc(notificationId).set({
                ...
                // do not insert groupId in order not to be deleted @onMemberDeleted
                "groupId": "",
                "postId": "",
...
exports.alertMembersByLastPostDateTime = functions.pubsub.schedule('0 0-23 * * *').onRun(async () => {
